                                ...
                                children: [
                                  ...
                                  Padding(
                                    padding: EdgeInsetsDirectional.fromSTEB(
                                        0.0, 6.0, 0.0, 0.0),
                                    child: Text(
                                      'A empresa agrade o seu apoio e \nesperamos que goste.',
                                      style: FlutterFlowTheme.of(context)
                                          .labelLarge
                                          .override(
                                            fontFamily: 'Outfit',
                                        ...
                                        children: [
                                          Padding(
                                            ...
                                            child: InkWell(
                                              ...
                                              onTap: () async {
                                                logFirebaseEvent(
                                                    'PROFILE_PAGE_Row_tf7e406k_ON_TAP');
                                                logFirebaseEvent(
                                                    'Row_navigate_to');
                                      ...
                                      children: [
                                        Padding(
                                          ...
                                          child: InkWell(
                                            ...
                                            onTap: () async {
                                              logFirebaseEvent(
                                                  'PROFILE_PAGE_Row_y3nqiolw_ON_TAP');
                                              logFirebaseEvent(
                                                  'Row_navigate_to');

                                              context
                                                  .pushNamed('SupportCenter');
                                            },
                                            child: Row(
                                              mainAxisSize: MainAxisSize.max,
                                              children: [
