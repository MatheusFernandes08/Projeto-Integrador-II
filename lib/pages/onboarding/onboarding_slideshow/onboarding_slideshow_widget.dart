                                          ...
                                          Padding(
                                            padding:
                                                EdgeInsetsDirectional.fromSTEB(
                                                    0.0, 48.0, 0.0, 0.0),
                                            child: Text(
                                              'Crie o seu Cupcake para quando ocorrer futuras atualizações.',
                                              textAlign: TextAlign.center,
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                      .labelLarge
                                          ...
                                          Padding(
                                            padding:
                                                EdgeInsetsDirectional.fromSTEB(
                                                    0.0, 48.0, 0.0, 0.0),
                                            child: Text(
                                              'Aproveite os diferentes sabores de cupcakes, saudáveis e entregas á sua porta, preparados com ingredientes frescos e de alta qualidade',
                                              textAlign: TextAlign.center,
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                      .labelLarge
                                          ...
                                          Padding(
                                            padding:
                                                EdgeInsetsDirectional.fromSTEB(
                                                    0.0, 48.0, 0.0, 0.0),
                                            child: Text(
                                              'Todos os produtos são inspirados no chef Matheus, especialista em doces, com a entrega meta gourmet.',
                                              textAlign: TextAlign.center,
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                      .labelLarge
