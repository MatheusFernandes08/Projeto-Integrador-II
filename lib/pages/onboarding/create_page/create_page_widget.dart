                                                  ...
                                                  Align(
                                                    ...
                                                    child: Padding(
                                                      ...
                                                      child: FFButtonWidget(
                                                        onPressed: () async {
                                                          logFirebaseEvent(
                                                              'CREATE_PAGE_PAGE_GET_STARTED_BTN_ON_TAP');
                                                          logFirebaseEvent(
                                                              'Button_auth');
                                                          GoRouter.of(context)
                                                              .prepareAuthEvent();
                                                              ...
                                                              Padding(
                                                                ...
                                                                child:
                                                                  ...
                                                                  onPressed:
                                                                      () async {
                                                                    logFirebaseEvent(
                                                                        'CREATE_CONTINUE_WITH_GOOGLE_BTN_ON_TAP');
                                                                    logFirebaseEvent(
                                                                        'Button_auth');
                                                                    GoRouter.of(
                                                                            context)
                                                                  ...
                                                                  : Padding(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        onPressed:
                                                                            () async {
                                                                          logFirebaseEvent(
                                                                              'CREATE_CONTINUE_WITH_APPLE_BTN_ON_TAP');
                                                                          logFirebaseEvent(
                                                                              'Button_auth');
                                                                          GoRouter.of(context)
                                                                              .prepareAuthEvent();
                                                  ...
                                                  Align(
                                                    ...
                                                    child: Padding(
                                                      ...
                                                      child: FFButtonWidget(
                                                        onPressed: () async {
                                                          logFirebaseEvent(
                                                              'CREATE_PAGE_PAGE_SIGN_IN_BTN_ON_TAP');
                                                          logFirebaseEvent(
                                                              'Button_auth');
                                                          GoRouter.of(context)
                                                              .prepareAuthEvent();
                                                  ...
                                                  Align(
                                                    ...
                                                    child: Padding(
                                                      ...
                                                      child: FFButtonWidget(
                                                        onPressed: () async {
                                                          logFirebaseEvent(
                                                              'CREATE_FORGOT_PASSWORD_BTN_ON_TAP');
                                                          logFirebaseEvent(
                                                              'Button_auth');
                                                          GoRouter.of(context)
                                                              .prepareAuthEvent();
